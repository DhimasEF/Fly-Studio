...
class Transaction extends Middle_Controller {
	...
	public function add() {
		...
		$this->load->view('Admin/sidebar', $data);
		$this->load->view('Admin/addtransaction', $data);
		$this->load->view('Admin/footer');
	}
	...
	public function pay($transaction_id) {
		...
		if ($_SERVER['REQUEST_METHOD'] === 'POST') {
			...
			if (!$this->upload->do_upload('payment_proof')) {
				...
				redirect('Admin/transaction/detail/' . rawurlencode(base64_encode($transaction_id)));
			}
   ...
   public function detail($encoded_id) {
		...
		// Load view
		$this->load->view('Admin/sidebar', $data);
		$this->load->view('Admin/detailtransaction', $data);
    ...
    public function edit($encoded_id) {
		...
		if ($this->input->post()) {
			...
			redirect('Admin/transaction/detail/' . rawurlencode(base64_encode($decoded_id)));
		}
