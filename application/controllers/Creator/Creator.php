...
class Creator extends Middle_Controller {
	...
	public function index() {
		...
		$data['creators'] = $this->M_User->get_all_role_creators_except_userlogin($user_id);

		$this->load->view('Creator/sidebar', $data);
        $this->load->view('Creator/listcreator', $data);
	...
	public function search() {
		...
		if (empty($keyword)) {
			...
			$data['creators'] = $this->M_User->search_role_creator_except_userlogin($keyword,$user_id);
		}
	...
	public function detail($encoded_id) {
		...
		// Load view
		$this->load->view('Creator/sidebar', $data);
		$this->load->view('Creator/creatorinfo', $data);
		$this->load->view('Creator/footer', $data);
	}
