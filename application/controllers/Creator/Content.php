...
class Content extends Middle_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Creator/listcontent', $data);
    ...
    // Add new content
     ...
     public function upload_form() {
        ...
        $this->load->view('Creator/sidebar', $data);
        $this->load->view('Creator/createcontent');
    ...
    public function upload() {
        ...
        if (!$this->upload->do_upload('file_url')) {
            ...
            $this->load->view('Creator/upload_initial', $data);
        } else {
            ...
            redirect('Creator/content/uploaddtl/' . $id_content);
        }
    }
	...
	public function uploaddtl($id_content) {
        ...
        if ($query->num_rows() == 0) {
            redirect('Creator/content/upload'); // Jika ID tidak ditemukan
        }
        ...
        $this->load->view('Creator/sidebar', $data);
        $this->load->view('Creator/createcontentdetail', $data);
        $this->load->view('Creator/footer', $data);
    }
	...
	public function save_content_details() {
        ...
        redirect('Creator/content'); // Redirect ke daftar konten setelah selesai
    }
	...
	public function view($encoded_id_content) {
		...
		// Load the view
        $this->load->view('Creator/sidebar', $data);
		$this->load->view('Creator/contentdtl', $data);
        $this->load->view('Creator/footer', $data);
	}
	...
	public function add_comment($encoded_id_content, $id_parent = null) {
		...
		if ($id_parent !== null) {
			...
			if (!$parent_comment) {
				...
				redirect('Creator/content/view/' . rawurlencode(base64_encode($id_content)));
				return;
			}
		}
	...
	public function edit($encoded_id) {
		...
		$data['user'] = $this->M_User->getCreatorById($user_id);
		$data['title'] = 'Edit Content ' . ($data['content']->title . ' | Fly Studio');

		$this->load->view('Creator/sidebar', $data);
		$this->load->view('Creator/editcontent', $data);
		$this->load->view('Creator/footer');
	}
