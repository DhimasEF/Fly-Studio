<div class="content">
	<div class="bg justify-between align-center">
		<h1 class="f3"><i class='bx bxs-profil-badge'></i>Dashboard / <span class="text2"><?= htmlspecialchars($user['name'] ?? 'Guest', ENT_QUOTES, 'UTF-8'); ?></span></h1>
		 <!-- Tombol Edit Profil -->
        <a href="<?= site_url('Creator/profil/edit/' . rawurlencode(base64_encode($user['id_user']))); ?>" class="edit-btn">
					...
					<div class="ml-25">
						...
						<?php else: ?>
							<div class="gap-1">
								...
								<a href="<?= base_url('Creator/Creator/' . ($is_following ? 'unfollow' : 'follow') . '/' . $encoded_id); ?>" 
								   class="follow-btn" 
			...
			<div class="row mt-2">
				<div class="col-3">
					<div class="relative f5">
						...
						<div class="f4 bg-post bgc1"><?= ucfirst(htmlspecialchars($user['team_name'] ?? '-', ENT_QUOTES, 'UTF-8')); ?>
						</div>
					</div>
			...
			<!-- Statistik Creator -->
				...
				<div class="justify-between">
					...
					<div class="see-more-wrap">
						<a href="<?= site_url('Creator/content'); ?>" class="see-more-btn">See more <i class="bx bx-chevron-right"></i></a>
					</div>
				</div>
				<?php if (!empty($posts)): ?>
					<div class="card-grid">
				...
				<div class="justify-between">
					...
					<div class="see-more-wrap">
						<a href="<?= site_url('Creator/collaboration'); ?>" class="see-more-btn">See more <i class="bx bx-chevron-right"></i></a>
					</div>
				</div>
