					...
					<?php foreach ($requests as $request): ?>
						<li class="request-card">
							...
							<div class="request-actions">
								<a href="<?= site_url('Creator/chat/respond_request/' . $request->id_chat_request . '/approve'); ?>"
								   title="Approve"
								   class="action-icon approve">
									<i class='bx bx-check-circle'></i>
								</a>
								<a href="<?= site_url('Creator/chat/respond_request/' . $request->id_chat_request . '/reject'); ?>"
								   title="Reject"
