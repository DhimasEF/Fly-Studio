<div class="content">   
    <div class="bg justify-between align-center">
        <h1 class="f3">
            <a class="no-deco" href="<?= base_url('Creator/profil') ?>"><i class='bx bx-user'></i> Edit Profil</a> /
            <span class="text2"><?= $user['name']; ?></span>
        </h1>
    </div>
    ...
    <div class="mt-2">
        ...
        <form action="<?= site_url('Creator/profil/update/' . rawurlencode(base64_encode($user['id_user']))) ?>" method="POST" enctype="multipart/form-data" class="trans-edit add-content">
