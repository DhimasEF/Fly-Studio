        ...
        <div class="l-navbar" id="navbar">
            <nav class="nav">
                <div>
                    ...
                    <ul class="nav__list">
						<a href="<?= base_url('Creator/profil'); ?>" class="nav__link" id="profile-link" data-href="profil">
						...
						<a href="<?= base_url('Creator/event'); ?>" class="nav__link" data-href="event">
							<i class='bx bx-bell nav__icon'></i>
							<span class="nav__text">Event</span>
						</a>
						<a href="<?= base_url('Creator/creator'); ?>" class="nav__link" data-href="creator">
							<i class='bx bx-palette nav__icon'></i>
							<span class="nav__text">Creator</span>
						</a>
                        <a href="<?= base_url('Creator/chat'); ?>" class="nav__link" data-href="chat">
                            <i class='bx bx-chat nav__icon' ></i>
                            <span class="nav__text">Chat</span>
                        </a>           
						<a href="<?= base_url('Creator/content'); ?>" class="nav__link" data-href="content">
                            <i class='bx bx-grid-alt nav__icon' ></i>
                            <span class="nav__text">Content</span>
                        </a>    
						<a href="<?= base_url('Creator/transaction'); ?>" class="nav__link" data-href="transaction">
							<i class='bx bx-transfer nav__icon'></i>
							<span class="nav__text">Transaction</span>
						</a>                 
                    </ul>
                </div>
                <a href="<?= base_url('Creator/profil/logout'); ?>" class="nav__link">           
