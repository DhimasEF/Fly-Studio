<div class="content">   
	...
	<div class="col-12 mt-2">
		<form action="<?= base_url('Creator/Creator/search'); ?>" method="get" class="search-form">
			<input type="text" name="keyword" placeholder="Cari creator..." value="<?= isset($_GET['keyword']) ? $_GET['keyword'] : ''; ?>">
			<button type="submit">Search</button>
			<a href="<?= base_url('Creator/Creator/search'); ?>">Reset</a>
		</form>
		...
		<div class="mt-2 creator-container">
			...
			?>
				<div class="creator-card">
					<a href="<?= base_url('Creator/Creator/detail/' . rawurlencode(base64_encode($creator['id_user']))); ?>">
