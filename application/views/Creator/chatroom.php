<div id="chat-container">
    ...
    <div id="message-section">
        ...
        <form id="send-message-form" method="POST" action="<?= site_url('Creator/chat/send_message_private/' . $room_id); ?>">
...
function openPrivateChat(chatRoomId) {
    ...
    window.location.href = '<?= site_url('Creator/chat/proom/') ?>' + chatRoomId;
}
</script>
...
function loadMessages() {
    $.ajax({
        url: "<?= site_url('Creator/chat/fetch_messages/' . $room_id) ?>", // private
        method: "GET",
