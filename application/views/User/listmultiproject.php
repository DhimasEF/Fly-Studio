<div class="content">   
	...
	<div class="col-12 mt-2">
		...
		<div class="content-nav">
			<a href="<?= base_url('User/content') ?>" class="<?= !$is_collab ? 'active' : '' ?>">
				<i class='bx bx-play'></i> Biasa
			</a>
			<a href="<?= base_url('User/collaboration') ?>" class="<?= $is_collab ? 'active' : '' ?>">
				...
				<?php foreach ($contents as $content): ?>
					<div class="content-cardc">
						...
						<div class="content-meta">
							...
							<a href="<?= base_url('User/collaboration/view/' . rawurlencode(base64_encode($content['id_file']))); ?>">
