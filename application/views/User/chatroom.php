<div id="chat-container">
    ...
    <div id="message-section">
        ...
        <!-- Send Form -->
        <form id="send-message-form" method="POST" action="<?= site_url('User/chat/send_message_private/' . $room_id); ?>">
...
function openPrivateChat(chatRoomId) {
    ...
    window.location.href = '<?= site_url('User/chat/proom/') ?>' + chatRoomId;
}
</script>
...
function loadMessages() {
    $.ajax({
        url: "<?= site_url('User/chat/fetch_messages/' . $room_id) ?>", // private
        method: "GET",
