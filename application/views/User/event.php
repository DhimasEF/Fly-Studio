<div class="content">   
	...
	<div class="col-12 mt-2">
		<div class="scope-filter">
			<a href="<?= base_url('User/event'); ?>" class="filter-btn <?= ($scope == '') ? 'active' : ''; ?>">Public</a>
			<a href="<?= base_url('User/event'); ?>?scope=all" class="filter-btn <?= ($scope == 'all') ? 'active' : ''; ?>">All</a>
		</div>
	</div>
			...
			<div class="event-card">
				...
				<div class="banner" style="background-image: url('<?= $banner_url ?>');">
					<div class="overlay">
						...
						<a href="<?= site_url('User/event/detail/' . rawurlencode(base64_encode($event->id_event))); ?>" class="detail-button">View Details</a>
					</div>
				</div>
			</div>
