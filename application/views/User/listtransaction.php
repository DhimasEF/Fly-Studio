<div class="content">   
	<div class="bg justify-between align-center">
		...
		<a href="<?= site_url('User/transaction/add'); ?>" class="create-room">
	...
	<div class="col-12 mt-2">
		...
		<div class="trans-filter-buttons">
			<a href="<?= site_url('User/transaction?filter=orderer'); ?>" class="nav-btn <?= ($current_filter === 'orderer') ? 'active' : ''; ?>">
					...
					<?php foreach ($filtered_transactions as $transaction): ?>
						<div class="transaction-card">
							...
							<div class="trans-card-body">
								...
								<a class="trans-detail-btn" href="<?= site_url('User/transaction/detail/' . rawurlencode(base64_encode($transaction->id_transaction))); ?>">
