					...
					<div class="ml-25">
						...
						<?php else: ?>
							<div class="gap-1">
								...
								<!-- Tombol Chat -->
								<a href="<?= base_url('User/chat/send_request/' . $creator['id_user']); ?>" class="btn-quick" title="Chat">
			...
			<!-- Statistik Creator -->
				...
				<div class="justify-between">
					...
					<div class="see-more-wrap">
						<a href="<?= site_url('User/content'); ?>" class="see-more-btn">See more <i class="bx bx-chevron-right"></i></a>
					</div>
				</div>
				<?php if (!empty($posts)): ?>
					<div class="card-grid">
