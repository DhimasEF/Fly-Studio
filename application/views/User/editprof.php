<div class="content">   
	<div class="bg justify-between align-center">
		<h1 class="f3">
			<a class="no-deco" href="<?= base_url('User/porfil') ?>"><i class='bx bx-user'></i> Edit Profil</a> /
	...
	<div class="mt-2">
		...
		<form action="<?= site_url('User/profil/update/' . rawurlencode(base64_encode($user->id_user))) ?>" method="POST" enctype="multipart/form-data" class="trans-edit">
