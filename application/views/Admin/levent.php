<div class="content">   
	<div class="bg justify-between align-center">
		...
		<a class="create-room" href="<?= site_url('Admin/event/create'); ?>">
	...
	<div class="col-12 mt-2">
		<div class="scope-filter">
			<?php $scope = strtolower($_GET['scope'] ?? ''); ?>
			<a href="<?= base_url('Admin/event'); ?>" class="filter-btn <?= ($scope == '') ? 'active' : ''; ?>">All Event</a>
			<a href="<?= base_url('Admin/event'); ?>?scope=public" class="filter-btn <?= ($scope == 'public') ? 'active' : ''; ?>">Public</a>
			<a href="<?= base_url('Admin/event'); ?>?scope=intern" class="filter-btn <?= ($scope == 'intern') ? 'active' : ''; ?>">Intern</a>
			<a href="<?= base_url('Admin/event'); ?>?scope=all" class="filter-btn <?= ($scope == 'all') ? 'active' : ''; ?>">All</a> <!-- jika ingin filter scope "all" yang id_scope = 3 -->
		</div>
	</div>
			...
			<div class="event-card">
				...
				<div class="banner" style="background-image: url('<?= $banner_url ?>');">
					<div class="overlay">
						...
						<a href="<?= site_url('Admin/event/detail/' . rawurlencode(base64_encode($event->id_event))); ?>" class="detail-button">View Details</a>
					</div>
				</div>
			</div>
