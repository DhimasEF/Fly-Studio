<div class="content">   
	<div class="bg justify-between align-center">
		<h1 class="f3">
			<a class="no-deco" href="<?= base_url('Admin/content') ?>"><i class='bx bxs-videos'></i>Edit Content</a> /
	...
	<div class="mt-2">
		<div class="add-content">
			<form action="<?= base_url('Admin/content/update/' . rawurlencode(base64_encode($content->id_content))) ?>" method="POST">
