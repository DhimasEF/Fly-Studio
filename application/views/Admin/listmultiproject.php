<div class="content">   
	<div class="bg justify-between align-center">
		...
		<a class="create-room" href="<?= base_url('Admin/collaboration/create'); ?>">
			<i class='bx bx-plus'></i> Upload Collaboration
		</a>
	</div>
	...
	<div class="col-12 mt-2">
		...
		<div class="content-nav">
			<a href="<?= base_url('Admin/content') ?>" class="<?= !$is_collab ? 'active' : '' ?>">
				<i class='bx bx-play'></i> Biasa
			</a>
			<a href="<?= base_url('Admin/collaboration') ?>" class="<?= $is_collab ? 'active' : '' ?>">
				...
				<?php foreach ($contents as $content): ?>
					<div class="content-cardc">
						...
						<div class="content-meta">
							...
							<a href="<?= base_url('Admin/collaboration/view/' . rawurlencode(base64_encode($content['id_file']))); ?>">
